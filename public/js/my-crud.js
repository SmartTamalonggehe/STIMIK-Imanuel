...
var swalDelete = function swalDelete(href) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
    ...
    if (result.isConfirmed) {
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        method: "delete",
        url: "/crud/".concat(route, "/").concat(href)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (swalDelete);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "save_method": () => (/* binding */ save_method),
/* harmony export */   "setSaveMethod": () => (/* binding */ setSaveMethod),
/* harmony export */   "toastr": () => (/* reexport default from dynamic */ toastr__WEBPACK_IMPORTED_MODULE_0___default.a)
/* harmony export */ });
...
var setSaveMethod = function setSaveMethod(set) {
  save_method = set;
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tools */ "./resources/js/my_crud/tools.js");
...
$(document).on("click", ".btn-ubah", function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    (0,_tools__WEBPACK_IMPORTED_MODULE_0__.setSaveMethod)("ubah"); // set attribut form

    document.getElementById("judul_form").innerText = "From Ubah Data";
    document.getElementById("tombolForm").innerText = "Simpan Data"; // call formData
...
var formData = function formData(data) {
  ...
  if (route == "aset_diam") {
    ...
    document.getElementById("nama").value = data.nama;
    document.getElementById("jenis_id").value = data.jenis_id;
    document.getElementById("ruangan_id").value = data.ruangan_id; // $("#ruangan_id").val(data.ruangan_id).trigger("change.select2");
...
"use strict";
/*!*********************************!*\
  !*** ./resources/js/my-crud.js ***!
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _my_crud_tambah__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my_crud/tambah */ "./resources/js/my_crud/tambah.js");
/* harmony import */ var _my_crud_ubah__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my_crud/ubah */ "./resources/js/my_crud/ubah.js");
